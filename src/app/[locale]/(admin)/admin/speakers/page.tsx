import { PlusIcon, ShieldAlertIcon, ShieldCheckIcon } from "lucide-react";
    ...
    <>
      ...
      <ul className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {speakers.map((s) => {
          ...
          return (
            <li key={s.id}>
              <Link href={`/admin/speakers/${s.id}`} className="block rounded-2xl bg-card p-4 ring-1 ring-border hover:ring-primary">
